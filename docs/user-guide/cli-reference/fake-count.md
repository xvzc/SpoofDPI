...
Specifies the number of fake packets to be sent before the Client Hello. If 'window-size' is greater than 0, each fake packet will be fragmented into segments of the specified window size. `(default: 0)`
